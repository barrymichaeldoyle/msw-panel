...
A floating button appears in the corner. Click it to open the panel and toggle any handler on or off. Adapters for Vue, Svelte, and other frameworks are coming soon.
